...
int test1(struct Options options)
{
	...
	fprintf(xml, "<testcase classname=\"test1\" name=\"de/serialization_lib\"");
	global_start_time = start_clock();
	failures = 0;
	MyLog(LOGA_INFO, "Starting test 1 - serialization_lib of connect and back");
...
int test2(struct Options options)
{
	...
	global_start_time = start_clock();
	failures = 0;
	MyLog(LOGA_INFO, "Starting test 2 - serialization_lib of publish and back");
...
#define TOPIC_COUNT 2
	...
	global_start_time = start_clock();
	failures = 0;
	MyLog(LOGA_INFO, "Starting test 2 - serialization_lib of subscribe and back");
...
#define TOPIC_COUNT 2
	...
	global_start_time = start_clock();
	failures = 0;
	MyLog(LOGA_INFO, "Starting test 4 - serialization_lib of suback and back");
...
#define TOPIC_COUNT 2
	...
	global_start_time = start_clock();
	failures = 0;
	MyLog(LOGA_INFO, "Starting test 2 - serialization_lib of unsubscribe and back");
...
int test6(struct Options options)
{
	...
	global_start_time = start_clock();
	failures = 0;
	MyLog(LOGA_INFO, "Starting test 2 - serialization_lib of connack and back");
